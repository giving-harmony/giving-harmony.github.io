const members = [
  {
    name: 'Katherine',
    title: 'Guest pianist',
    bio: "Katherine Wong is an undergraduate student at Stanford University studying Symbolic Systems (Computer Science + Psychology, Philosophy, and Linguistics) and English. In college, she is involved in Stanford's Chamber Music program, where she performs in a piano quartet. Katherine has been playing the piano since the age of five; at eight years old, Katherine made her debut at the Lincoln Center in New York City. Since then, she has performed at numerous prestigious concert halls around the world, including Carnegie Hall in New York City (4x), Mozarteum in Austria, Concertgebouw in the Netherlands, Megaron Concert Hall in Greece, and Parco della Musica in Italy. She has been recognized as a Panel Masters award winner in the MTAC Certificate of Merit Program, nominated as an Orange County Artist of the Year, named a California Young Artist Scholar, and awarded top winner prizes at the American Fine Arts Festival International Music Competition, Bremen International Piano Competition (Japan), North International Piano Competition (Sweden). In addition, Katherine was selected to perform a solo charity concert at the National Taipei National Concert Hall during summer of 2021 before COVID-19. She also plays the cello and has been recognized as a Level 10 Advanced Cello award winner of MTAC's Certificate of Merit Program."
  }, {
    ...
    title: 'pianist',
    bio: "Thomas Wu is a pianist who has been playing for more than 8 years. A junior at Valencia High School, Thomas' hobbies extend beyond piano, as he also enjoys tinkering with computer keyboards, traveling, and videography. Thomas is also passionate about photography and learning how to edit photos."
  }, {
    ...
    bio: 'Nadia Wang is a sophomore in Diamond Bar High School. She studied piano at the age of five with Dr. Svetlana Transky, and has since won many competitions, including L.A. Young Pianists, Elite International Music, Colibri International, International Keyboard Odyssiad & Festival (Level A), DBHS Concerto, SCP Concerto, SYMF Concerto and others. She performed in Carnegie Hall in 2018 and performed with the SCP Orchestra as a piano soloist in 2020. To serve the society, Nadia has volunteered to perform in many senior living homes and adult daycare centers throughout the southland. In addition to playing piano, Nadia enjoys singing, dancing, reading and composing music.',
    ...
    bio: 'Pianist, cellist, violinist, and striving composer, Chloe Wei is a passionate musician who hopes to inspire people with her music. She has participated in MTAC Music Festivals for 4 years on the piano along with the Youth SCSBOA Honor Orchestra for 2 years with the cello and violin. Recently, she participated in JCM and is currently a cellist in Pacific Symphony Santiago Strings. In addition, Chloe also attended an MTAC CT State Contest for her composed song and MTAC Improvisation Recital where she was selected to present her improvised song for the MTAC Convention in 2021. Chloe is currently a freshman at Orange Lutheran and hopes to do many things in the future with music.'
  }, {
